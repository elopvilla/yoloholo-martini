...
namespace YoloHolo.YoloLabeling
{
    public class YoloObjectLabeler : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            GameObject.Find("TextDebug").GetComponent<TextMeshProUGUI>().text += "Initializing imageAcquirerService";
            imageAcquirer = ServiceManager.Instance.GetService<IImageAcquiringService>();
            GameObject.Find("TextDebug").GetComponent<TextMeshProUGUI>().text += "<br>ImageAcquirerServiceInitialized";
            imageAcquirer.Initialize(new Vector2Int(yoloImageSize.x, yoloImageSize.y));
            GameObject.Find("TextDebug").GetComponent<TextMeshProUGUI>().text += "<br>Start To Recognize";
        ...
        private async Task StartRecognizingAsync()
        {
            ...
            do
            {
                GameObject.Find("TextDebug").GetComponent<TextMeshProUGUI>().text += "<br>Looping til cameraSize is set";
